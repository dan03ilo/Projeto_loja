...
class Produto{
    ...
    */
    public function cadastro(){
        $query = "insert into produtos set nome=:n, descricao=:d, preco=:p, imagem1=:i1, imagem2=:i2, imagem3=:i3, imagem4=:i4 ";
    ...
    public function alterarProduto(){
        $query = "update produtos set nome=:n, descricao=:d, preco=:p, imagem1=:i1, imagem2=:i2, imagem3=:i3, imagem4=:i4 where id=:i";
