...
/*
Este cabeçalho permite o acesso a listagem de endereço 
...
/*
vamos definir qual será o formato de dados que o endereço 
...
/*
O arquivo contato.php foi incluido para que a classe Endereco fosse 
utilizada. Vale lembrar que esta classe possui o CRUD para o endereço.
*/
...
consulta no formato sql que seleciona todos os contato("Select * from endereco")
...
if($stmt->rowCount() > 0){
/*
Para organizar os endereços cadastrados em banco e exibi-los em tela, foi
criado uma array com o nome de saida e assim guardar todos endereços.
*/
    $endereco_arr["saida"]=array();

    /*
    A estrutura while(enquanto) realizar a busca e todos os endereços
     cadastrados até chegar ao final da tabela e tras os dados 
     para fetch array organizar em formato de array.
     Assim será mais fácil de adicionar no array de endereços para ser
     apresentado ao contato. 
    */
    while($linha = $stmt->fetch(PDO::FETCH_ASSOC)){
        /*
        O comando extract é capaz de separar de forma mais simples 
        os campos da tabela endereço.
        */
        extract($linha);

        /*
        Pegar um campo por vez do comando extract e adicionar em um 
        array de itens, pois será assim que os endereços serão tratados, 
        um endereço por vez com seus respectivos dados.
        */
        $array_item = array(
            "id"=>$id,
        ...
        que é um endereço com seus respectivos dados.
        */
    ...
    */
    ...
    a mensagem "mensagem: Não há endereços cadastrados" que será mostrada por meio
